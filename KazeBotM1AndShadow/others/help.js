...
module.exports = {
  ...
  async execute(message,args,client) {
    ...
    let helpEmbed = new MessageEmbed()
      ...
      .setFooter( client.user.username +`Type: ${prefix}help <Command>  for more information!`, "https://images-ext-2.discordapp.net/external/YBBIFS4oJOlI7nNJfMkj9Zf75QU1nmfRVenNOCMsMf8/%3Fsize%3D2048/https/cdn.discordapp.com/avatars/893178922827673620/b193575cfd73377498acd65b4f115570.png")
      .setColor("#c219d8");
